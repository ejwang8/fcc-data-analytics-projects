...
def calculate_demographic_data(print_data=True):
    ...
    # Calculated but not used in final output — kept for clarity
    higher_education = higher_edu_df.shape[0]
    lower_education = lower_edu_df.shape[0]

    # percentage with salary >50K
    higher_education_rich = round(100 * (higher_edu_df["salary"] == ">50K").mean(), 1)
    lower_education_rich = round(100 * (lower_edu_df["salary"] == ">50K").mean(), 1)
